...
import 'package:orderbook/screens/MarketListScreen.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    this.context.read<WebSocketData>().changeText(_counter.toString());
...
//            Flexible(
//              child: Text('${context.watch<WebSocketData>().orderBook}'),
//            ),
          ],
        ),
      ),
